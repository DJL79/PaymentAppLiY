...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_ROOT}/BraintreeVisaCheckout/VisaCheckout_IOS_SDK/VisaCheckoutSDK.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/BraintreeVisaCheckout/BraintreeVisaCheckout.framework"
